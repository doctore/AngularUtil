...
import { Failure, Success, Try } from '@app-core/type/functional';
import {
  FFunction0,
  FFunction1,
  FFunction2,
 ...
 *
 *    ng test --include src/app/core/type/functional/try.type.spec.ts
 */
describe('Try', () => {
  ...
  describe('combine', () => {
    ...
    it('when given tries are null, undefined or empty then a Success with null value is returned', () => {
      ...
      expect(Try.combine(mapperFailure, mapperSuccess, null).isSuccess()).toBe(true);
      expect(Try.combine(mapperFailure, mapperSuccess, null).get()).toBeNull();

      expect(Try.combine(mapperFailure, mapperSuccess, undefined).isSuccess()).toBe(true);
      expect(Try.combine(mapperFailure, mapperSuccess, undefined).get()).toBeNull();

      expect(Try.combine(mapperFailure, mapperSuccess, []).isSuccess()).toBe(true);
    ...
    it('when all tries are Success then a Success applying mapperSuccess is returned', () => {
      ...
      expect(Try.combine(mapperFailure, mapperSuccess, tries).isSuccess()).toBe(true);
    ...
    it('when tries contains Failure then a Failure applying mapperFailure is returned', () => {
      ...
      expect(Try.combine(mapperFailure, mapperSuccess, tries).isSuccess()).toBe(false);
  ...
  describe('combineGetFirstFailure', () => {
    ...
    it('when given tries are null, undefined or empty then a Success with null value is returned', () => {
      ...
      expect(Try.combineGetFirstFailure(mapperSuccess, null).isSuccess()).toBe(true);
      expect(Try.combineGetFirstFailure(mapperSuccess, null).get()).toBeNull();

      expect(Try.combineGetFirstFailure(mapperSuccess, undefined).isSuccess()).toBe(true);
      expect(Try.combineGetFirstFailure(mapperSuccess, undefined).get()).toBeNull();

      expect(Try.combineGetFirstFailure(mapperSuccess, []).isSuccess()).toBe(true);
    ...
    it('when all tries are Success then a Success applying mapperSuccess is returned', () => {
      ...
      expect(Try.combineGetFirstFailure(mapperSuccess, tries).isSuccess()).toBe(true);
    ...
    it('when tries contains Failure then the first one is returned', () => {
      ...
      expect(Try.combineGetFirstFailure(mapperSuccess, tries).isSuccess()).toBe(false);
  ...
  describe('ofFunction0', () => {
    ...
    it('when no func is provided then a Failure with the error is returned', () => {
      ...
      expect(tryResult.getError() instanceof IllegalArgumentError).toBe(true);
    });
  ...
  describe('success', () => {
    ...
    it('when null or undefined value is given then empty Success is returned', () => {
      expect(Try.success(null).isSuccess()).toBe(true);
      expect(Try.success(null).get()).toBeNull();

      expect(Try.success(undefined).isSuccess()).toBe(true);
      expect(Try.success(undefined).get()).toBe(undefined);
    });
    ...
    it('when a valid value is given then non empty Success is returned', () => {
      ...
      expect(Try.success(intValue).isSuccess()).toBe(true);
      expect(Try.success(intValue).get()).toEqual(intValue);

      expect(Try.success(stringValue).isSuccess()).toBe(true);
  ...
  describe('failure', () => {
    ...
    it('when a valid value is given then no error is thrown and it will be stored internally', () => {
      ...
      expect(Try.failure(illegalArgumentError).isSuccess()).toBe(false);
      expect(Try.failure(illegalArgumentError).getError()).toEqual(illegalArgumentError);

      expect(Try.failure(referenceError).isSuccess()).toBe(false);
  ...
  describe('ap', () => {
    ...
    it('when given Try and this one are Failure then mapperFailure is invoked and mapperSuccess is not', () => {
      ...
      const sumValuesSpy = vi.fn(sumValues);
      const mergeErrorsSpy = vi.fn(mergeErrors);
      ...
      expect(sumValuesSpy).toBeCalledTimes(0);
      expect(mergeErrorsSpy).toBeCalledTimes(1);
    });
    ...
    it('when given Try and this one are Success then mapperSuccess is invoked and mapperFailure is not', () => {
      ...
      expect(sumValuesSpy).toBeCalledTimes(1);
      expect(mergeErrorsSpy).toBeCalledTimes(0);
    });
    ...
    it('when one of the Try is Failure then Failure is returned', () => {
      ...
      expect(successApFailureResult.isSuccess()).toBe(false);
      expect(successApFailureResult.getError()).toEqual(illegalArgumentError);

      expect(failureApFailureResult.isSuccess()).toBe(false);
    ...
    it('when given Try and this one are Failure but mapperFailure is null or undefined then Failure is returned because missing mapperFailure', () => {
      ...
      expect(t1Apt2.isSuccess()).toBe(false);
      expect(t1Apt2.getError() instanceof Error).toBe(true);
      expect(t1Apt2.getError().message).toEqual(errorMissingMapperFailure.message);

      expect(t2Apt1.isSuccess()).toBe(false);
      expect(t2Apt1.getError() instanceof Error).toBe(true);
    ...
    it('when given Try and this one are Success then mapperSuccess result is returned', () => {
      ...
      expect(t1Apt2.isSuccess()).toBe(true);
      expect(t1Apt2.get()).toEqual(30);

      expect(t2Apt1.isSuccess()).toBe(true);
  ...
  describe('fold', () => {
    ...
    it('when the Try is Failure then mapperFailure is invoked and mapperSuccess is not', () => {
      ...
      const returnErrorMessageSpy = vi.fn(returnErrorMessage);
      ...
      expect(returnErrorMessageSpy).toBeCalledTimes(1);
    });
    ...
    it('when the Try is Success then mapperSuccess is invoked and mapperFailure is not', () => {
      ...
      expect(returnErrorMessageSpy).toBeCalledTimes(0);
    });
  ...
  describe('getOrElse', () => {
    ...
    it('when the Try instance is a Success one then the content of Success is returned', () => {
      expect(Try.success<NullableOrUndefined<string>>(undefined).getOrElse('11')).toBe(undefined);
    ...
    it('when the Try instance is a Failure one and provided other is a value then other is returned', () => {
      ...
      expect(failure.getOrElse(undefined)).toBe(undefined);
  ...
  describe('isEmpty', () => {
    ...
    it('when the Try instance is an empty Success one then true is returned', () => {
      expect(Try.success(null).isEmpty()).toBe(true);
      expect(Try.success(undefined).isEmpty()).toBe(true);

      expect(Try.success<NullableOrUndefined<string>>(undefined).isEmpty()).toBe(true);
      expect(Try.success<Nullable<number>>(null).isEmpty()).toBe(true);
    });


    it('when the Try instance is a non-empty Success one then false is returned', () => {
      expect(Try.success(12).isEmpty()).toBe(false);
      expect(Try.success('abc').isEmpty()).toBe(false);
    });


    it('when the Try instance is a Failure one then true is returned', () => {
      expect(Try.failure(new IllegalArgumentError('IllegalArgumentError: there was an error')).isEmpty()).toBe(true);
    });
  ...
  describe('map', () => {
    ...
    it('when the Try instance is Failure then same one is returned', () => {
      ...
      expect(result.getError() instanceof IllegalArgumentError).toBe(true);
  ...
  describe('mapFailure', () => {
    ...
    it('when the Try instance is Failure then mapper is invoked', () => {
      ...
      const throwSyntaxErrorSpy = vi.fn(throwSyntaxError);

      const failureTry: Try<number> = Try.failure(illegalArgumentError);

      failureTry.mapFailure(throwSyntaxErrorSpy);

      expect(throwSyntaxErrorSpy).toBeCalledTimes(1);
    });
    ...
    it('when the Try instance is Success then mapper is not invoked', () => {
      ...
      expect(throwSyntaxErrorSpy).toBeCalledTimes(0);
    });
    ...
    it('when the Try instance is Failure then new Try applying mapper is returned', () => {
      ...
      expect(result.isSuccess()).toBe(false);
      expect(result.getError() instanceof SyntaxError).toBe(true);
  ...
  describe('orElse', () => {
    ...
    it('when the Try instance is Failure and provided other is a TFunction0 instance then other is returned', () => {
      ...
      expect(failureTry.orElse(otherRaw).isSuccess()).toBe(true);
      expect(failureTry.orElse(otherRaw).get()).toEqual(successTry.get());

      expect(failureTry.orElse(otherFFunction).isSuccess()).toBe(true);
      expect(failureTry.orElse(otherFFunction).get()).toEqual(successTry.get());

      expect(failureTry.orElse(otherFunction).isSuccess()).toBe(true);
    ...
    it('when the Try instance is Right then same Try is returned', () => {
      ...
      expect(successTry.orElse(failureTry).isSuccess()).toBe(true);
      expect(successTry.orElse(failureTry).get()).toEqual(successTry.get());

      expect(successTry.orElse(other).isSuccess()).toBe(true);
  ...
  describe('recover', () => {
    ...
    it('when the Try instance is Success then mapper is not invoked', () => {
      ...
      expect(getErrorMessageSpy).toBeCalledTimes(0);
    });
  ...
  describe('toEither', () => {
    ...
    it('when the Try instance is an empty Success one then empty Right is returned', () => {
      expect(Try.success(null).toEither().isRight()).toBe(true);
      expect(Try.success(null).toEither().get()).toBeNull();

      expect(Try.success(undefined).toEither().isRight()).toBe(true);
      expect(Try.success(undefined).toEither().get()).toBe(undefined);
    });
    ...
    it('when the Try instance is a non empty Success one then non empty Right is returned', () => {
      ...
      expect(intSuccess.toEither().isRight()).toBe(true);
      expect(intSuccess.toEither().get()).toEqual(intSuccess.get());

      expect(stringSuccess.toEither().isRight()).toBe(true);
    ...
    it('when the Try instance is a Failure one then a Left instance is returned', () => {
      ...
      expect(failure.toEither().isRight()).toBe(false);
  ...
  describe('toOptional', () => {
    ...
    it('when the Try instance is an empty Success one then empty Optional is returned', () => {
      expect(Try.success(null).toOptional().isPresent()).toBe(false);
      expect(Try.success(undefined).toOptional().isPresent()).toBe(false);

      expect(Try.success<NullableOrUndefined<string>>(undefined).toOptional().isPresent()).toBe(false);
      expect(Try.success<Nullable<number>>(null).toOptional().isPresent()).toBe(false);
    });
    ...
    it('when the Try instance is a non empty Success one then non empty Optional is returned', () => {
      ...
      expect(intSuccess.toOptional().isPresent()).toBe(true);
      expect(intSuccess.toOptional().get()).toEqual(intSuccess.get());

      expect(stringSuccess.toOptional().isPresent()).toBe(true);
    ...
    it('when the Try instance is a Failure one then empty Optional is returned', () => {
      ...
      expect(failure.toOptional().isPresent()).toBe(false);
    });
  ...
  describe('toValidation', () => {
    ...
    it('when the Try instance is an empty Success one then empty Valid is returned', () => {
      expect(Try.success(null).toValidation().isValid()).toBe(true);
      expect(Try.success(null).toValidation().get()).toBeNull();

      expect(Try.success(undefined).toValidation().isValid()).toBe(true);
      expect(Try.success(undefined).toValidation().get()).toBe(undefined);
    });
    ...
    it('when the Try instance is a non empty Success one then non empty Valid is returned', () => {
      ...
      expect(intSuccess.toValidation().isValid()).toBe(true);
      expect(intSuccess.toValidation().get()).toEqual(intSuccess.get());

      expect(stringSuccess.toValidation().isValid()).toBe(true);
    ...
    it('when the Try instance is a Failure one then an Invalid instance is returned', () => {
      ...
      expect(failure.toValidation().isValid()).toBe(false);
...
describe('Success', () => {
  ...
  describe('of', () => {
    ...
    it('when a value is given then it will be stored internally', () => {
      ...
      expect(Success.of<NullableOrUndefined<string>>(undefined).isSuccess()).toBe(true);
      expect(Success.of<NullableOrUndefined<string>>(undefined).get()).toBe(undefined);

      expect(Success.of<Nullable<number>>(null).isSuccess()).toBe(true);
      expect(Success.of<Nullable<number>>(null).get()).toBeNull();

      expect(Success.of(intValue).isSuccess()).toBe(true);
  ...
  describe('isSuccess', () => {
    ...
    it('then true is returned', () => {
      expect(Success.of<NullableOrUndefined<string>>(undefined).isSuccess()).toBe(true);
      expect(Success.of<Nullable<number>>(null).isSuccess()).toBe(true);
      expect(Success.of(12).isSuccess()).toBe(true);
    });
...
describe('Failure', () => {
  ...
  describe('of', () => {
    ...
    it('when a valid value is given then no error is thrown and it will be stored internally', () => {
      ...
      expect(Failure.of(illegalArgumentError).isSuccess()).toBe(false);
      expect(Failure.of(illegalArgumentError).getError()).toEqual(illegalArgumentError);

      expect(Failure.of(referenceError).isSuccess()).toBe(false);
  ...
  describe('isSuccess', () => {
    ...
    it('then false is returned', () => {
      expect(Failure.of(new IllegalArgumentError('There was an error')).isSuccess()).toBe(false);
      expect(Failure.of(new ReferenceError('There was an error')).isSuccess()).toBe(false);
    });
