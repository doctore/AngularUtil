import { Either, Invalid, Try, Valid, Validate, Validation, ValidationError } from '@app-core/type/functional';
import { Nullable, NullableOrUndefined } from '@app-core/type';
import { FFunction0, FFunction1, Function0, Function1, TFunction0 } from '@app-core/type/function';
 ...
 *
 *    ng test --include src/app/core/type/functional/validation.type.spec.ts
 */
describe('Validation', () => {
  ...
  describe('valid', () => {
    ...
    it('a new Valid instance is returned', () => {
      expect(Validation.valid<number, NullableOrUndefined<string>>(undefined).isValid()).toBe(true);
      expect(Validation.valid<number, NullableOrUndefined<string>>(undefined).get()).toBe(undefined);

      expect(Validation.valid<boolean, Nullable<number>>(null).isValid()).toBe(true);
      expect(Validation.valid<boolean, Nullable<number>>(null).get()).toBeNull();

      expect(Validation.valid(12).isValid()).toBe(true);
  ...
  describe('invalid', () => {
    ...
    it('a new Invalid instance is returned', () => {
      ...
      // @ts-ignore
      expect(Validation.invalid<string, number>(undefined).isValid()).toBe(false);
      // @ts-ignore
      expect(Validation.invalid<string, number>(undefined).getErrors()).toEqual([]);

      // @ts-ignore
      expect(Validation.invalid<string, number>(null).isValid()).toBe(false);
      // @ts-ignore
      expect(Validation.invalid<string, number>(null).getErrors()).toEqual([]);

      expect(Validation.invalid<string, number>(errors).isValid()).toBe(false);
  ...
  describe('combine', () => {
    ...
    it('when given validations are null, undefined or empty then a Valid with null value is returned', () => {
      expect(Validation.combine(null).isValid()).toBe(true);
      expect(Validation.combine(undefined).isValid()).toBe(true);
      expect(Validation.combine([]).isValid()).toBe(true);
    });
    ...
    it('when all validations are Valid then last Valid instance is returned', () => {
      ...
      expect(Validation.combine(validations).isValid()).toBe(true);
    ...
    it('when all validations contain Invalid then Invalid instance merging all is returned', () => {
      ...
      expect(Validation.combine(validations).isValid()).toBe(false);
  ...
  describe('combineGetFirstInvalid', () => {
    ...
    it('when given validations are null, undefined or empty then a Valid with null value is returned', () => {
      expect(Validation.combineGetFirstInvalid(null).isValid()).toBe(true);
      expect(Validation.combineGetFirstInvalid(undefined).isValid()).toBe(true);
      expect(Validation.combineGetFirstInvalid([]).isValid()).toBe(true);
    });
    ...
    it('when all validations are Valid then last Valid instance is returned', () => {
      ...
      expect(Validation.combineGetFirstInvalid(validations).isValid()).toBe(true);
    ...
    it('when all validations contain Invalid then first Invalid instance is returned', () => {
      ...
      expect(Validation.combineGetFirstInvalid(validations).isValid()).toBe(false);
  ...
  describe('combineAllAndGetFirstInvalid', () => {
    ...
    it('when given verifyAll and verifyUpToFirstInvalid are null, undefined or empty then a Valid with null value is returned', () => {
      expect(Validation.combineAllAndGetFirstInvalid(null, null).isValid()).toBe(true);
      expect(Validation.combineAllAndGetFirstInvalid(null, undefined).isValid()).toBe(true);
      expect(Validation.combineAllAndGetFirstInvalid(undefined, undefined).isValid()).toBe(true);
      expect(Validation.combineAllAndGetFirstInvalid(undefined, null).isValid()).toBe(true);

      expect(Validation.combineAllAndGetFirstInvalid([], []).isValid()).toBe(true);
      expect(Validation.combineAllAndGetFirstInvalid(null, []).isValid()).toBe(true);
      expect(Validation.combineAllAndGetFirstInvalid([], null).isValid()).toBe(true);
      expect(Validation.combineAllAndGetFirstInvalid(undefined, []).isValid()).toBe(true);
      expect(Validation.combineAllAndGetFirstInvalid([], undefined).isValid()).toBe(true);
    });
    ...
    it('when verifyAll contains Invalid then Invalid instance merging all is returned', () => {
      ...
      expect(Validation.combineAllAndGetFirstInvalid(verifyAll, verifyUpToFirstInvalid).isValid()).toBe(false);
    ...
    it('when given verifyAll and verifyUpToFirstInvalid are Valid then last Valid instance is returned', () => {
      ...
      expect(Validation.combineAllAndGetFirstInvalid(verifyAll, verifyUpToFirstInvalid).isValid()).toBe(true);
  ...
  describe('fromEither', () => {
    ...
    it('when the Either instance is an empty Right one then empty Valid is returned', () => {
      expect(Validation.fromEither(Either.right(null)).isValid()).toBe(true);
      expect(Validation.fromEither(Either.right(null)).get()).toBeNull();

      expect(Validation.fromEither(Either.right(undefined)).isValid()).toBe(true);
      expect(Validation.fromEither(Either.right(undefined)).get()).toBe(undefined);
    });
    ...
    it('when the Either instance is a non empty Right one then non empty Valid is returned', () => {
      ...
      expect(Validation.fromEither(intRight).isValid()).toBe(true);
      expect(Validation.fromEither(intRight).get()).toEqual(intRight.get());

      expect(Validation.fromEither(stringRight).isValid()).toBe(true);
    ...
    it('when the Either instance is a Left one then an Invalid instance is returned', () => {
      ...
      expect(Validation.fromEither(left).isValid()).toBe(false);
  ...
  describe('fromTry', () => {
    ...
    it('when the Try instance is an empty Success one then empty Valid is returned', () => {
      expect(Validation.fromTry(Try.success(null)).isValid()).toBe(true);
      expect(Validation.fromTry(Try.success(null)).get()).toBeNull();

      expect(Validation.fromTry(Try.success(undefined)).isValid()).toBe(true);
      expect(Validation.fromTry(Try.success(undefined)).get()).toBe(undefined);
    });
    ...
    it('when the Try instance is a non empty Success one then non empty Valid is returned', () => {
      ...
      expect(Validation.fromTry(intSuccess).isValid()).toBe(true);
      expect(Validation.fromTry(intSuccess).get()).toEqual(intSuccess.get());

      expect(Validation.fromTry(stringSuccess).isValid()).toBe(true);
    ...
    it('when the Try instance is a Failure one then an Invalid instance is returned', () => {
      ...
      expect(Validation.fromTry(failure).isValid()).toBe(false);
  ...
  describe('ap', () => {
    ...
    it('when given validation is null or undefined then this Validation is returned', () => {
      ...
      // @ts-ignore
      expect(valid.ap(null).isValid()).toBe(true);
      // @ts-ignore
      expect(valid.ap(null)).toEqual(valid);

      // @ts-ignore
      expect(invalid.ap(undefined).isValid()).toBe(false);
      // @ts-ignore
    ...
    it('when given validation and this are Valid then new Valid is returned', () => {
      ...
      expect(v1.ap(v2).isValid()).toBe(true);
      expect(v1.ap(v2).get()).toEqual(v2.get());

      expect(v2.ap(v1).isValid()).toBe(true);
    ...
    it('when given validation is Invalid and this is Valid then new Invalid is returned', () => {
      ...
      expect(valid.ap(invalid).isValid()).toBe(false);
    ...
    it('when given validation is Valid and this is Invalid then new Invalid is returned', () => {
      ...
      expect(invalid.ap(valid).isValid()).toBe(false);
  ...
  describe('filter', () => {
    ...
    it('when given Validation is a Valid one but does not match with provided predicate then undefined is returned', () => {
      ...
      expect(v1.filter(isEven)).toBe(undefined);
      expect(v2.filter(isEven)).toBe(undefined);
    });
  ...
  describe('filterOptional', () => {
    ...
    it('when given Validation is an Invalid one then not empty Optional containing such instance is returned', () => {
      ...
      expect(v1Result.isPresent()).toBe(true);
      expect(v1Result.get().isValid()).toBe(false);
      expect(v1Result.get().getErrors()).toEqual(v1.getErrors());

      expect(v2Result.isPresent()).toBe(true);
      expect(v2Result.get().isValid()).toBe(false);
    ...
    it('when given Validation is a Valid one but predicate is null or undefined then not empty Optional containing such instance is returned', () => {
      ...
      expect(v1Result.isPresent()).toBe(true);
      expect(v1Result.get().isValid()).toBe(true);
      expect(v1Result.get().get()).toEqual(v1.get());

      expect(v2Result.isPresent()).toBe(true);
      expect(v2Result.get().isValid()).toBe(true);
    ...
    it('when given Validation is a Valid one but does not match with provided predicate then empty Optional is returned', () => {
      ...
      expect(v1Result.isPresent()).toBe(false);
      expect(v2Result.isPresent()).toBe(false);
    });
  ...
  describe('fold', () => {
    ...
    it('when given Validation is Invalid then mapperInvalid is invoked and mapperValid is not', () => {
      ...
      const stringArrayLengthSpy = vi.fn(stringArrayLength);
      ...
      expect(stringArrayLengthSpy).toBeCalledTimes(1);
    ...
    it('when given Validation is Valid then mapperValid is invoked and mapperInvalid is not', () => {
      ...
      expect(stringArrayLengthSpy).toBeCalledTimes(0);
  ...
  describe('getOrElse', () => {
    ...
    it('when given Validation is a Valid one then the content of Valid is returned', () => {
      expect(Validation.valid<number, NullableOrUndefined<string>>(undefined).getOrElse('11')).toBe(undefined);
    ...
    it('when given Validation is an Invalid one and provided other is a value then other is returned', () => {
      ...
      expect(validation.getOrElse(undefined)).toBe(undefined);
  ...
  describe('isEmpty', () => {
    ...
    it('when the Validation instance is an empty Valid one then true is returned', () => {
      expect(Validation.valid(null).isEmpty()).toBe(true);
      expect(Validation.valid(undefined).isEmpty()).toBe(true);

      expect(Validation.valid<number, NullableOrUndefined<string>>(null).isEmpty()).toBe(true);
      expect(Validation.valid<number, NullableOrUndefined<string>>(undefined).isEmpty()).toBe(true);
    });


    it('when the Validation instance is a non-empty Valid one then false is returned', () => {
      expect(Validation.valid(12).isEmpty()).toBe(false);
      expect(Validation.valid('abc').isEmpty()).toBe(false);
    });


    it('when the Validation instance is an Invalid one then true is returned', () => {
      // @ts-ignore
      expect(Validation.invalid(null).isEmpty()).toBe(true);
      // @ts-ignore
      expect(Validation.invalid(undefined).isEmpty()).toBe(true);
      expect(Validation.invalid([12]).isEmpty()).toBe(true);
      expect(Validation.invalid(['abc']).isEmpty()).toBe(true);
    });
  ...
  describe('orElse', () => {
    ...
    it('when given Validation is Invalid and provided other is a TFunction0 instance then other is returned', () => {
      ...
      expect(invalidValidation.orElse(otherRaw).isValid()).toBe(true);
      expect(invalidValidation.orElse(otherRaw).get()).toEqual(validValidation.get());

      expect(invalidValidation.orElse(otherFFunction).isValid()).toBe(true);
      expect(invalidValidation.orElse(otherFFunction).get()).toEqual(validValidation.get());

      expect(invalidValidation.orElse(otherFunction).isValid()).toBe(true);
    ...
    it('when the Validation instance is Valid then same Validation is returned', () => {
      ...
      expect(validValidation.orElse(invalidValidation).isValid()).toBe(true);
      expect(validValidation.orElse(invalidValidation).get()).toEqual(validValidation.get());

      expect(validValidation.orElse(other).isValid()).toBe(true);
  ...
  describe('toEither', () => {
    ...
    it('when the Validation instance is an empty Valid one then empty Right is returned', () => {
      expect(Validation.valid(null).toEither().isRight()).toBe(true);
      expect(Validation.valid(null).toEither().get()).toBeNull();

      expect(Validation.valid(undefined).toEither().isRight()).toBe(true);
      expect(Validation.valid(undefined).toEither().get()).toBe(undefined);
    });
    ...
    it('when the Validation instance is a non empty Valid one then non empty Right is returned', () => {
      ...
      expect(intValid.toEither().isRight()).toBe(true);
      expect(intValid.toEither().get()).toEqual(intValid.get());

      expect(stringValid.toEither().isRight()).toBe(true);
    ...
    it('when the Validation instance is an Invalid one then a Left instance is returned', () => {
      ...
      expect(invalid.toEither().isRight()).toBe(false);
  ...
  describe('toOptional', () => {
    ...
    it('when the Validation instance is an empty Valid one then empty Optional is returned', () => {
      expect(Validation.valid(null).toOptional().isPresent()).toBe(false);
      expect(Validation.valid(undefined).toOptional().isPresent()).toBe(false);
    });
    ...
    it('when the Validation instance is an Invalid one then empty Optional is returned', () => {
      // @ts-ignore
      expect(Validation.invalid(null).toOptional().isPresent()).toBe(false);
      // @ts-ignore
      expect(Validation.invalid(undefined).toOptional().isPresent()).toBe(false);

      expect(Validation.invalid([12]).toOptional().isPresent()).toBe(false);
      expect(Validation.invalid(['abc']).toOptional().isPresent()).toBe(false);
    });
  ...
  describe('toTry', () => {
    ...
    it('when given Validation is an empty Valid one then empty Success is returned', () => {
      ...
      expect(v1Result.isSuccess()).toBe(true);
      expect(v1Result.isEmpty()).toBe(true);

      expect(v2Result.isSuccess()).toBe(true);
      expect(v2Result.isEmpty()).toBe(true);
    });
    ...
    it('when given Validation is a non empty Valid one then non empty Success is returned', () => {
      ...
      expect(v1Result.isSuccess()).toBe(true);
      expect(v1Result.isEmpty()).toBe(false);
      expect(v1Result.get()).toEqual(v1.get());

      expect(v2Result.isSuccess()).toBe(true);
      expect(v2Result.isEmpty()).toBe(false);
      expect(v2Result.get()).toEqual(v2.get());
    });
...
describe('Valid', () => {
  ...
  describe('of', () => {
    ...
    it('when a value is given then new Valid instance is returned', () => {
      ...
      expect(Valid.of<boolean, NullableOrUndefined<string>>(undefined).isValid()).toBe(true);
      expect(Valid.of<boolean, NullableOrUndefined<string>>(undefined).get()).toBe(undefined);

      expect(Valid.of<boolean, NullableOrUndefined<string>>(null).isValid()).toBe(true);
      expect(Valid.of<boolean, NullableOrUndefined<string>>(null).get()).toBeNull();

      expect(Valid.of(intValue).isValid()).toBe(true);
  ...
  describe('isValid', () => {
    ...
    it('then true is returned', () => {
      // @ts-ignore
      expect(Valid.of(null).isValid()).toBe(true);
      // @ts-ignore
      expect(Valid.of(undefined).isValid()).toBe(true);
      expect(Valid.of(19).isValid()).toBe(true);
    });
...
describe('Invalid', () => {
  ...
  describe('of', () => {
    ...
    it('when no errors are provided then new Invalid instance with empty errors is returned', () => {
      // @ts-ignore
      expect(Invalid.of<string, number>(undefined).isValid()).toBe(false);
      // @ts-ignore
      expect(Invalid.of<string, number>(undefined).getErrors()).toEqual([]);

      // @ts-ignore
      expect(Invalid.of<string, number>(null).isValid()).toBe(false);
      // @ts-ignore
    ...
    it('when errors are provided then new Invalid instance with given errors is returned', () => {
      ...
      expect(Invalid.of<string, number>(errors).isValid()).toBe(false);
  ...
  describe('isValid', () => {
    ...
    it('then false is returned', () => {
      // @ts-ignore
      expect(Invalid.of(null).isValid()).toBe(false);
      // @ts-ignore
      expect(Invalid.of(undefined).isValid()).toBe(false);
      expect(Invalid.of([]).isValid()).toBe(false);
    });
...
describe('Validate', () => {
  ...
  describe('validateWithCombine', () => {
    ...
    it('when provided instance does not verify rules then an Invalid instance with an array of ValidationError is returned', () => {
      ...
      expect(resultInvalidPizzaName.isValid()).toBe(false);
      ...
      expect(resultInvalidPizzaCost.isValid()).toBe(false);
      ...
      expect(resultInvalidPizzaNameAndCost.isValid()).toBe(false);
    ...
    it('when provided instance verifies rules then a Valid instance is returned', () => {
      ...
      expect(resultValidPizzaName.isValid()).toBe(true);
...
describe('ValidationError', () => {
  ...
  describe('compareTo', () => {
    ...
    it('when given other is neither null nor undefined then expected comparison result is returned', () => {
      ...
      expect(0 > validationError1.compareTo(validationError2)).toBe(true);

      expect(validationError2.compareTo(validationError2)).toEqual(0);
      expect(0 < validationError2.compareTo(validationError1)).toBe(true);
    });
  ...
  describe('equals', () => {
    ...
    it('when other is null or undefined then false is returned', () => {
      ...
      expect(validationError.equals(null)).toBe(false);
      expect(validationError.equals(undefined)).toBe(false);
    });
    ...
    it('when this and other are not equal then false is returned', () => {
      ...
      expect(validationError1.equals(validationError2)).toBe(false);
      expect(validationError2.equals(validationError1)).toBe(false);

      expect(validationError1.equals(validationError3)).toBe(false);
      expect(validationError3.equals(validationError1)).toBe(false);

      expect(validationError1.equals(validationError4)).toBe(false);
      expect(validationError4.equals(validationError1)).toBe(false);

      expect(validationError2.equals(validationError3)).toBe(false);
      expect(validationError3.equals(validationError2)).toBe(false);

      expect(validationError2.equals(validationError4)).toBe(false);
      expect(validationError4.equals(validationError2)).toBe(false);

      expect(validationError3.equals(validationError4)).toBe(false);
      expect(validationError4.equals(validationError3)).toBe(false);
    });
    ...
    it('when this and other are equal then true is returned', () => {
      ...
      expect(validationError1.equals(validationError2)).toBe(true);
      expect(validationError2.equals(validationError1)).toBe(true);

      expect(validationError1.equals(validationError1)).toBe(true);
      expect(validationError2.equals(validationError2)).toBe(true);
    });
