 ...
 *         `false` otherwise
 */
export function isFConsumer4<T1, T2, T3, T4>(input?: unknown): input is FConsumer4<T1, T2, T3, T4> {
...
export class Consumer4<T1, T2, T3, T4> {
   ...
   *         `false` otherwise
   */
  static isConsumer = <T1, T2, T3, T4>(input?: unknown): input is Consumer4<T1, T2, T3, T4> =>
