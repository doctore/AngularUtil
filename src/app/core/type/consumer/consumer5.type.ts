 ...
 *         `false` otherwise
 */
export function isFConsumer5<T1, T2, T3, T4, T5>(input?: unknown): input is FConsumer5<T1, T2, T3, T4, T5> {
...
export class Consumer5<T1, T2, T3, T4, T5> {
   ...
   *         `false` otherwise
   */
  static isConsumer = <T1, T2, T3, T4, T5>(input?: unknown): input is Consumer5<T1, T2, T3, T4, T5> =>
