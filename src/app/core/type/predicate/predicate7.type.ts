 ...
 *         `false` otherwise
 */
export function isFPredicate7<T1, T2, T3, T4, T5, T6, T7>(input?: unknown): input is FPredicate7<T1, T2, T3, T4, T5, T6, T7> {
...
export class Predicate7<T1, T2, T3, T4, T5, T6, T7> {
   ...
   *         `false` otherwise
   */
  static isPredicate = <T1, T2, T3, T4, T5, T6, T7>(input?: unknown): input is Predicate7<T1, T2, T3, T4, T5, T6, T7> =>
