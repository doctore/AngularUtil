 ...
 *         `false` otherwise
 */
export function isFPredicate4<T1, T2, T3, T4>(input?: unknown): input is FPredicate4<T1, T2, T3, T4> {
...
export class Predicate4<T1, T2, T3, T4> {
   ...
   *         `false` otherwise
   */
  static isPredicate = <T1, T2, T3, T4>(input?: unknown): input is Predicate4<T1, T2, T3, T4> =>
