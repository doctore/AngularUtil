 ...
 *         `false` otherwise
 */
export function isFPredicate6<T1, T2, T3, T4, T5, T6>(input?: unknown): input is FPredicate6<T1, T2, T3, T4, T5, T6> {
...
export class Predicate6<T1, T2, T3, T4, T5, T6> {
   ...
   *         `false` otherwise
   */
  static isPredicate = <T1, T2, T3, T4, T5, T6>(input?: unknown): input is Predicate6<T1, T2, T3, T4, T5, T6> =>
