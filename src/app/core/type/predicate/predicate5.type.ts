 ...
 *         `false` otherwise
 */
export function isFPredicate5<T1, T2, T3, T4, T5>(input?: unknown): input is FPredicate5<T1, T2, T3, T4, T5> {
...
export class Predicate5<T1, T2, T3, T4, T5> {
  ...
  static alwaysFalse = <T1, T2, T3, T4, T5>(): Predicate5<T1, T2, T3, T4, T5> =>
    new Predicate5<T1, T2, T3, T4, T5>(
      (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5) => false
    );
  ...
  static alwaysTrue = <T1, T2, T3, T4, T5>(): Predicate5<T1, T2, T3, T4, T5> =>
    new Predicate5<T1, T2, T3, T4, T5>(
      (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5) => true
    );
   ...
   *         `false` otherwise
   */
  static isPredicate = <T1, T2, T3, T4, T5>(input?: unknown): input is Predicate5<T1, T2, T3, T4, T5> =>
    ...
    ObjectUtil.isNullOrUndefined(predicate)
      ...
      : new Predicate5(
          (t1: T1,
           ...
           t5: T5) =>
            this.apply(t1, t2, t3, t4, t5) &&
              Predicate5.of(predicate)
                .apply(t1, t2, t3, t4, t5)
        );


  /**
   * Evaluates this {@link Predicate5} for the given types `T1`, `T2`, `T3`, `T4` and `T5` instances.
   *
   * @param t1
