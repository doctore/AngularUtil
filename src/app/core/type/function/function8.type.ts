...
/**
 * Arrow function that accepts eight arguments and produces a result.
 *
 * @typeParam <T1>
 ...
 *         `false` otherwise
 */
export function isFFunction8<T1, T2, T3, T4, T5, T6, T7, T8, R>(input?: unknown): input is FFunction8<T1, T2, T3, T4, T5, T6, T7, T8, R> {
...
export class Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> {
   ...
   *         `false` otherwise
   */
  static isFunction = <T1, T2, T3, T4, T5, T6, T7, T8, R>(input?: unknown): input is Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> =>
