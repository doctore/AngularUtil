...
/**
 * Arrow function that accepts seven arguments and produces a result.
 *
 * @typeParam <T1>
 ...
 *         `false` otherwise
 */
export function isFFunction7<T1, T2, T3, T4, T5, T6, T7, R>(input?: unknown): input is FFunction7<T1, T2, T3, T4, T5, T6, T7, R> {
...
export class Function7<T1, T2, T3, T4, T5, T6, T7, R> {
   ...
   *         `false` otherwise
   */
  static isFunction = <T1, T2, T3, T4, T5, T6, T7, R>(input?: unknown): input is Function7<T1, T2, T3, T4, T5, T6, T7, R> =>
  ...
  /**
   * Applies this {@link Function7} to the given arguments.
   *
   * @param t1
