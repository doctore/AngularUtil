...
/**
 * Arrow function that accepts nine arguments and produces a result.
 *
 * @typeParam <T1>
 ...
 *         `false` otherwise
 */
export function isFFunction9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R>(input?: unknown): input is FFunction9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> {
...
export class Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> {
   ...
   *         `false` otherwise
   */
  static isFunction = <T1, T2, T3, T4, T5, T6, T7, T8, T9, R>(input?: unknown): input is Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> =>
