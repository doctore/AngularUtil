...
import { Function1, TFunction1 } from '@app-core/type/function';
 ...
 *         `false` otherwise
 */
export function isFFunction4<T1, T2, T3, T4, R>(input?: unknown): input is FFunction4<T1, T2, T3, T4, R> {
...
/**
 * Represents a function that accepts four arguments and produces a result, used as wrapper of {@link FFunction4}.
 * <p>
 * This is a functional interface whose functional method is {@link Function4#apply}.
 *
 * @typeParam <T1>
 *   Type of the first input to the {@link Function4}
 * @typeParam <T2>
 *   Type of the second input to the {@link Function4}
 * @typeParam <T3>
 *   Type of the third input to the {@link Function4}
 * @typeParam <T4>
 *   Type of the fourth input to the {@link Function4}
 * @typeParam <R>
...
export class Function4<T1, T2, T3, T4, R> {
   ...
   *         `false` otherwise
   */
  static isFunction = <T1, T2, T3, T4, R>(input?: unknown): input is Function4<T1, T2, T3, T4, R> =>
    ...
    undefined !== (input as Function4<T1, T2, T3, T4, R>).getMapper &&
    isFFunction4((input as Function4<T1, T2, T3, T4, R>).getMapper());
   ...
   *
   * @return {@link FFunction4}
   */
  getMapper = (): FFunction4<T1, T2, T3, T4, R> =>
    this.mapper;
  ...
  /**
   * Applies this {@link Function4} to the given arguments.
   *
   * @param t1
