...
/**
 * Arrow function that accepts six arguments and produces a result.
 *
 * @typeParam <T1>
 ...
 *         `false` otherwise
 */
export function isFFunction6<T1, T2, T3, T4, T5, T6, R>(input?: unknown): input is FFunction6<T1, T2, T3, T4, T5, T6, R> {
...
export class Function6<T1, T2, T3, T4, T5, T6, R> {
   ...
   *         `false` otherwise
   */
  static isFunction = <T1, T2, T3, T4, T5, T6, R>(input?: unknown): input is Function6<T1, T2, T3, T4, T5, T6, R> =>
    ...
    isFFunction6((input as Function6<T1, T2, T3, T4, T5, T6, R>).getMapper());
  ...
  /**
   * Applies this {@link Function6} to the given arguments.
   *
   * @param t1
