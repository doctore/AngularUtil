...
import { FPredicate1, FPredicate2, Predicate1, Predicate2, TPredicate1, TPredicate2 } from '@app-core/type/predicate';
...
export class PartialFunction<T, R> {
   ...
   *         `false` otherwise
   */
  static isPartialFunction = <T, R>(input?: unknown): input is PartialFunction<T, R> =>
    ...
    undefined !== (input as PartialFunction<T, R>).lift &&
    undefined !== (input as PartialFunction<T, R>).orElse;
  ...
  static ofKeyValueMapper<T, K, V>(verifier: NullableOrUndefined<FPredicate1<T>>,
  ...
  static of2<T1, T2, R>(verifier: NullableOrUndefined<FPredicate2<T1, T2>>,
  ...
  static of2KeyValueMapper<T1, T2, R1, R2>(verifier: NullableOrUndefined<FPredicate2<T1, R1>>,
