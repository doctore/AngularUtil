...
/**
 * Arrow function that accepts five arguments and produces a result.
 *
 * @typeParam <T1>
 ...
 *         `false` otherwise
 */
export function isFFunction5<T1, T2, T3, T4, T5, R>(input?: unknown): input is FFunction5<T1, T2, T3, T4, T5, R> {
...
export class Function5<T1, T2, T3, T4, T5, R> {
   ...
   *         `false` otherwise
   */
  static isFunction = <T1, T2, T3, T4, T5, R>(input?: unknown): input is Function5<T1, T2, T3, T4, T5, R> =>
