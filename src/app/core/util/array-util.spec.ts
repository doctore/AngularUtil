...
describe('ArrayUtil', () => {
  ...
  describe('collectFirst', () => {
    ...
    it('when given sourceArray has no elements and partialFunction is provided then empty Optional is returned', () => {
      ...
      expect(ArrayUtil.collectFirst(null, multiply2AndStringForEvenPP).isPresent()).toBe(false);
      expect(ArrayUtil.collectFirst(undefined, multiply2AndStringForEvenPP).isPresent()).toBe(false);
      expect(ArrayUtil.collectFirst(emptyArray, multiply2AndStringForEvenPP).isPresent()).toBe(false);
    });
  ...
  describe('filter', () => {
    ...
    it('when given sourceArray has no elements then empty array is returned', () => {
      ...
      expect(ArrayUtil.filter(null, isRoleIdEvenRaw)).toEqual(emptyArray);
      expect(ArrayUtil.filter(undefined, isRoleIdEvenRaw)).toEqual(emptyArray);
      expect(ArrayUtil.filter(emptyArray, isRoleIdEvenRaw)).toEqual(emptyArray);
    });
  ...
  describe('filterFirst', () => {
    ...
    it('when given sourceArray is undefined, null or is an empty array and filterPredicate is provided then undefined is returned', () => {
      ...
      expect(ArrayUtil.filterFirst(null, isRoleIdOddPredicate)).toBe(undefined);
      expect(ArrayUtil.filterFirst(emptyArray, isRoleIdOddPredicate)).toBe(undefined);
    });
    ...
    it('when given sourceArray is not empty, filterPredicate is provided but there is no element that filter then undefined is returned', () => {
      const r1 = { id: 1, name: 'role1' } as Role;
      const r2 = { id: 2, name: 'role2' } as Role;
    ...
    it('when given sourceArray is not empty, filterPredicate is provided and there is an element that matches then expected element is returned', () => {
  ...
  describe('filterFirstIndex', () => {
    ...
    it('when given sourceArray is undefined, null or is an empty array and filterPredicate is provided then -1 is returned', () => {
      ...
      expect(ArrayUtil.filterFirstIndex(null, isRoleIdOddPredicate)).toBe(-1);
      expect(ArrayUtil.filterFirstIndex(emptyArray, isRoleIdOddPredicate)).toBe(-1);
    });
    ...
    it('when given sourceArray is not empty, filterPredicate is provided but there is no element that filter then -1 is returned', () => {
      const r1 = { id: 1, name: 'role1' } as Role;
      const r2 = { id: 2, name: 'role2' } as Role;
      const r3 = { id: 2, name: 'role3' } as Role;
      const r4 = { id: 4, name: 'role2' } as Role;
    ...
    it('when given sourceArray is not empty, filterPredicate is provided and there is an element that matches then its position is returned', () => {
      const u1 = new User(1, 'user1');
      const u2 = new User(2, 'user2');
      const u3 = new User(1, 'user2');
      const u4 = new User(4, 'user1');

      expect(ArrayUtil.filterFirstIndex([u1, u2, u3, u4], isUserIdOddRaw)).toEqual(0);
    });
  ...
  describe('filterLast', () => {
    ...
    it('when given sourceArray is undefined, null or is an empty array and filterPredicate is provided then undefined is returned', () => {
      ...
      expect(ArrayUtil.filterLast(null, isRoleIdOddPredicate)).toBe(undefined);
      expect(ArrayUtil.filterLast(emptyArray, isRoleIdOddPredicate)).toBe(undefined);
    });


    it('when given sourceArray is not empty but filterPredicate is null or undefined then undefined is returned', () => {
      expect(ArrayUtil.filterLast([1], undefined)).toBe(undefined);
      expect(ArrayUtil.filterLast([1], null)).toBe(undefined);
    });
  ...
  describe('filterNot', () => {
    ...
    it('when given sourceArray has no elements then empty array is returned', () => {
      ...
      expect(ArrayUtil.filterNot(null, isRoleIdEvenPredicate)).toEqual(emptyArray);
      expect(ArrayUtil.filterNot(undefined, isRoleIdEvenPredicate)).toEqual(emptyArray);
      expect(ArrayUtil.filterNot(emptyArray, isRoleIdEvenPredicate)).toEqual(emptyArray);
    });
  ...
  describe('find', () => {
    ...
    it('when given sourceArray is undefined, null or is an empty array and item is provided then undefined is returned', () => {
      ...
      expect(ArrayUtil.find(undefined, role)).toBe(undefined);
      expect(ArrayUtil.find(null, role)).toBe(undefined);
      expect(ArrayUtil.find(emptyArray, role)).toBe(undefined);
    });
    ...
    it('when given sourceArray is undefined, null or is an empty array and item and equalsFunction are provided then undefined is returned', () => {
      ...
      expect(ArrayUtil.find(undefined, role, areAllRolePropertiesEqualsFPredicate)).toBe(undefined);
      expect(ArrayUtil.find(null, role, areAllRolePropertiesEqualsFPredicate)).toBe(undefined);
      expect(ArrayUtil.find(emptyArray, role, areAllRolePropertiesEqualsFPredicate)).toBe(undefined);
    });
    ...
    it('when given sourceArray is not empty, item is provided but there is no element that matches then undefined is returned', () => {
      ...
      expect(ArrayUtil.find(sourceArray, uToSearch)).toBe(undefined);
      expect(ArrayUtil.find(sourceArray, uToSearch, null)).toBe(undefined);
      expect(ArrayUtil.find(sourceArray, uToSearch, areUsersEqualsByIdRaw)).toBe(undefined);
      expect(ArrayUtil.find(sourceArray, uToSearch, areAllUserPropertiesEqualsFPredicate)).toBe(undefined);
      expect(ArrayUtil.find(sourceArray, uToSearch, areUsersEqualsPredicate)).toBe(undefined);
    });
    ...
    it('when given sourceArray is not empty, item is provided and there is an element that matches then expected element is returned', () => {
      ...
      expect(ArrayUtil.find(sourceArray, r2)).toEqual(r2);
      expect(ArrayUtil.find(sourceArray, r2, null)).toEqual(r2);
      expect(ArrayUtil.find(sourceArray, r3, areRolesEqualsByIdRaw)).toEqual(r2);
      expect(ArrayUtil.find(sourceArray, r2SameId, areRolesEqualsByIdRaw)).toEqual(r2);
      expect(ArrayUtil.find(sourceArray, r2Cloned, areAllRolePropertiesEqualsFPredicate)).toEqual(r2);
      expect(ArrayUtil.find(sourceArray, r3, areRolesEqualsPredicate)).toEqual(r3);
    });
  ...
  describe('findIndex', () => {
    ...
    it('when given sourceArray is undefined, null or is an empty array and item is provided then -1 is returned', () => {
      ...
      expect(ArrayUtil.findIndex(undefined, role)).toBe(-1);
      expect(ArrayUtil.findIndex(null, role)).toBe(-1);
      expect(ArrayUtil.findIndex(emptyArray, role)).toBe(-1);
    });
    ...
    it('when given sourceArray is undefined, null or is an empty array and item and equalsFunction are provided then -1 is returned', () => {
      ...
      expect(ArrayUtil.findIndex(undefined, role, areAllRolePropertiesEqualsFPredicate)).toBe(-1);
      expect(ArrayUtil.findIndex(null, role, areAllRolePropertiesEqualsFPredicate)).toBe(-1);
      expect(ArrayUtil.findIndex(emptyArray, role, areAllRolePropertiesEqualsFPredicate)).toBe(-1);
    });
    ...
    it('when given sourceArray is not empty, item is provided but there is no element that matches then -1 is returned', () => {
      ...
      expect(ArrayUtil.findIndex(sourceArray, uToSearch)).toBe(-1);
      expect(ArrayUtil.findIndex(sourceArray, uToSearch, null)).toBe(-1);
      expect(ArrayUtil.findIndex(sourceArray, uToSearch, areUsersEqualsByIdRaw)).toBe(-1);
      expect(ArrayUtil.findIndex(sourceArray, uToSearch, areAllUserPropertiesEqualsFPredicate)).toBe(-1);
      expect(ArrayUtil.findIndex(sourceArray, uToSearch, areUsersEqualsPredicate)).toBe(-1);
    });
    ...
    it('when given sourceArray is not empty, item is provided and there is an element that matches then its position is returned', () => {
      ...
      expect(ArrayUtil.findIndex(sourceArray, r2, null)).toEqual(1);
      expect(ArrayUtil.findIndex(sourceArray, r3, areRolesEqualsByIdRaw)).toEqual(1);
      expect(ArrayUtil.findIndex(sourceArray, r2SameId, areRolesEqualsByIdRaw)).toEqual(1);
      expect(ArrayUtil.findIndex(sourceArray, r2Cloned, areAllRolePropertiesEqualsFPredicate)).toEqual(1);
      expect(ArrayUtil.findIndex(sourceArray, r3, areRolesEqualsPredicate)).toEqual(2);
    });
  ...
  describe('findLast', () => {
    ...
    it('when given sourceArray is undefined, null or is an empty array and item is provided then undefined is returned', () => {
      ...
      expect(ArrayUtil.findLast(undefined, role)).toBe(undefined);
      expect(ArrayUtil.findLast(null, role)).toBe(undefined);
      expect(ArrayUtil.findLast(emptyArray, role)).toBe(undefined);
    });
    ...
    it('when given sourceArray is undefined, null or is an empty array and item and equalsFunction are provided then undefined is returned', () => {
      ...
      expect(ArrayUtil.findLast(undefined, role, areAllRolePropertiesEqualsFPredicate)).toBe(undefined);
      expect(ArrayUtil.findLast(null, role, areAllRolePropertiesEqualsFPredicate)).toBe(undefined);
      expect(ArrayUtil.findLast(emptyArray, role, areAllRolePropertiesEqualsFPredicate)).toBe(undefined);
    });
    ...
    it('when given sourceArray is not empty, item is provided but there is no element that matches then undefined is returned', () => {
      ...
      expect(ArrayUtil.findLast(sourceArray, uToSearch)).toBe(undefined);
      expect(ArrayUtil.findLast(sourceArray, uToSearch, null)).toBe(undefined);
      expect(ArrayUtil.findLast(sourceArray, uToSearch, areUsersEqualsByIdRaw)).toBe(undefined);
      expect(ArrayUtil.findLast(sourceArray, uToSearch, areAllUserPropertiesEqualsFPredicate)).toBe(undefined);
      expect(ArrayUtil.findLast(sourceArray, uToSearch, areUsersEqualsPredicate)).toBe(undefined);
    });
    ...
    it('when given sourceArray is not empty, item is provided and there is an element that matches then expected element is returned', () => {
      ...
      expect(ArrayUtil.findLast(sourceArray, r2, null)).toEqual(r2);
      expect(ArrayUtil.findLast(sourceArray, r2, areRolesEqualsByIdRaw)).toEqual(r3);
      expect(ArrayUtil.findLast(sourceArray, r2SameId, areRolesEqualsByIdRaw)).toEqual(r3);
      expect(ArrayUtil.findLast(sourceArray, r2Cloned, areAllRolePropertiesEqualsFPredicate)).toEqual(r2);
      expect(ArrayUtil.findLast(sourceArray, r3, areRolesEqualsPredicate)).toEqual(r3);
    });
  ...
  describe('findOptional', () => {
    ...
    it('when given sourceArray is undefined, null or is an empty array then empty Optional is returned', () => {
      ...
      expect(ArrayUtil.findOptional(undefined, role).isPresent()).toBe(false);
      expect(ArrayUtil.findOptional(null, role).isPresent()).toBe(false);
      expect(ArrayUtil.findOptional(emptyArray, role).isPresent()).toBe(false);
    });
    ...
    it('when given sourceArray is not empty, item is provided but there is no element that matches then empty Optional is returned', () => {
      ...
      expect(ArrayUtil.findOptional(sourceArray, uToSearch).isPresent()).toBe(false);
      expect(ArrayUtil.findOptional(sourceArray, uToSearch, null).isPresent()).toBe(false);
      expect(ArrayUtil.findOptional(sourceArray, uToSearch, areUsersEqualsByIdRaw).isPresent()).toBe(false);
      expect(ArrayUtil.findOptional(sourceArray, uToSearch, areAllUserPropertiesEqualsFPredicate).isPresent()).toBe(false);
      expect(ArrayUtil.findOptional(sourceArray, uToSearch, areUsersEqualsPredicate).isPresent()).toBe(false);
    });
    ...
    it('when given sourceArray is not empty, item is provided and there is an element that matches then Optional with expected element is returned', () => {
      ...
      expect(ArrayUtil.findOptional(sourceArray, r2, null).isPresent()).toBe(true);
      expect(ArrayUtil.findOptional(sourceArray, r2, null).get()).toEqual(r2);

      expect(ArrayUtil.findOptional(sourceArray, r3, areRolesEqualsByIdRaw).isPresent()).toBe(true);
      expect(ArrayUtil.findOptional(sourceArray, r3, areRolesEqualsByIdRaw).get()).toEqual(r2);

      expect(ArrayUtil.findOptional(sourceArray, r2SameId, areRolesEqualsByIdRaw).isPresent()).toBe(true);
      expect(ArrayUtil.findOptional(sourceArray, r2SameId, areRolesEqualsByIdRaw).get()).toEqual(r2);

      expect(ArrayUtil.findOptional(sourceArray, r2Cloned, areAllRolePropertiesEqualsFPredicate).isPresent()).toBe(true);
      expect(ArrayUtil.findOptional(sourceArray, r2Cloned, areAllRolePropertiesEqualsFPredicate).get()).toEqual(r2);

      expect(ArrayUtil.findOptional(sourceArray, r3, areRolesEqualsPredicate).isPresent()).toBe(true);
      expect(ArrayUtil.findOptional(sourceArray, r3, areRolesEqualsPredicate).get()).toEqual(r3);
    });
  ...
  describe('foldLeft', () => {
    ...
    it('when given sourceArray is not null but accumulator is null or undefined then initialValue is returned', () => {
      const intValue = 10;
    ...
    it('when given sourceArray is not empty and accumulator is provided then initialValue applying accumulator is returned', () => {
      const intValue = 10;
      const stringValue = 'a';
  ...
  describe('foldRight', () => {
    ...
    it('when given sourceArray is null, undefined or empty then initialValue is returned', () => {
      ...
      const intNullResult = ArrayUtil.foldRight(null, intValue, intAccumulator);
      const intUndefinedResult = ArrayUtil.foldRight(undefined, intValue, intAccumulator);
      const stringResult = ArrayUtil.foldRight([], stringValue, stringAccumulator);
    ...
    it('when given sourceArray is not null but accumulator is null or undefined then initialValue is returned', () => {
      ...
      const nullAccumulatorResult = ArrayUtil.foldRight(intArray, intValue, null);
      const undefinedAccumulatorResult = ArrayUtil.foldRight(intArray, intValue, undefined);
    ...
    it('when given sourceArray is not empty and accumulator is provided then initialValue applying accumulator is returned', () => {
      ...
      const intResult = ArrayUtil.foldRight(intArray, intValue, intAccumulator);
      const stringResult = ArrayUtil.foldRight(stringArray, stringValue, stringAccumulator);

      expect(intResult).toEqual(240);
      expect(stringResult).toEqual('adcb');
    });
  ...
  describe('groupBy', () => {
    ...
    it('when given sourceArray has elements and discriminatorKey is provided but filterPredicate is null or undefined then all elements will be grouped using discriminatorKey', () => {
    ...
    it('when given sourceArray has elements and discriminatorKey and filterPredicate are provided then a new filtered and grouped Map is returned', () => {
      const sourceArray: number[] = [ 1, 2, 3, 6, 3 ];
  ...
  describe('groupByMultiKey', () => {
    ...
    it('when given sourceArray has no elements and discriminatorKey and filterPredicate are provided then empty Map is returned', () => {
      ...
      expect(ArrayUtil.groupByMultiKey(null, oddEvenAndCompareWith5Raw, lessThan10Raw)).toEqual(expectedResult);
      expect(ArrayUtil.groupByMultiKey(undefined, oddEvenAndCompareWith5Raw, lessThan10Raw)).toEqual(expectedResult);
      expect(ArrayUtil.groupByMultiKey(emptyArray, oddEvenAndCompareWith5Raw, lessThan10Raw)).toEqual(expectedResult);
    });
    ...
    it('when given sourceArray has elements and discriminatorKey is provided but filterPredicate is null or undefined then all elements will be grouped using discriminatorKey', () => {
      ...
      verifyMaps(
        // @ts-ignore
        ArrayUtil.groupByMultiKey(sourceArray, oddEvenAndCompareWith5FFunction, null),
        expectedResult
      );
      verifyMaps(
        ArrayUtil.groupByMultiKey(sourceArray, oddEvenAndCompareWith5FFunction, undefined),
        expectedResult
      );
    });
    ...
    it('when given sourceArray has elements and discriminatorKey and filterPredicate are provided then a new filtered and grouped Map is returned', () => {
      ...
      verifyMaps(
        ArrayUtil.groupByMultiKey(sourceArray, oddEvenAndCompareWith5Raw, lessThan10Raw),
        expectedResult
      );
    });
  ...
  describe('groupMap', () => {
    ...
    it('when given sourceArray has no elements and discriminatorKey, valueMapper and filterPredicate are provided then empty Map is returned', () => {
      ...
      expect(ArrayUtil.groupMap(null, sameNumberRaw, plus1Raw, isOddRaw)).toEqual(expectedResult);
      expect(ArrayUtil.groupMap(undefined, sameNumberRaw, plus1Raw, isOddRaw)).toEqual(expectedResult);
      expect(ArrayUtil.groupMap(emptyArray, sameNumberRaw, plus1Raw, isOddRaw)).toEqual(expectedResult);
    });
    ...
    it('when given sourceArray is not empty but discriminatorKey or valueMapper are null or undefined then an error is thrown', () => {
      ...
      // @ts-ignore
      expect(() => ArrayUtil.groupMap([ 1 ], sameNumberRaw, null, isOddRaw)).toThrowError(IllegalArgumentError);
      // @ts-ignore
      expect(() => ArrayUtil.groupMap([ 1 ], sameNumberRaw, undefined, isOddRaw)).toThrowError(IllegalArgumentError);
    });
    ...
    it('when given sourceArray has elements and discriminatorKey and valueMapper are valid but filterPredicate is null or undefined then all elements will be transformed using discriminatorKey and valueMapper', () => {
      ...
      verifyMaps(
        // @ts-ignore
        ArrayUtil.groupMap(sourceArray, sameNumberFFunction, plus1FFunction, null),
        expectedResult
      );
      verifyMaps(
        ArrayUtil.groupMap(sourceArray, sameNumberFFunction, plus1FFunction, undefined),
        expectedResult
      );
    });
    ...
    it('when given sourceArray has elements and discriminatorKey, valueMapper and filterPredicate are valid then a new filtered and transformed Map is returned', () => {
      ...
      verifyMaps(
        ArrayUtil.groupMap(sourceArray, sameNumberRaw, plus1Raw, isOddRaw),
        expectedResult
      );
    });
  ...
  describe('groupMapMultiKey', () => {
    ...
    it('when given sourceArray has no elements and discriminatorKey, valueMapper and filterPredicate are provided then empty Map is returned', () => {
      ...
      expect(ArrayUtil.groupMapMultiKey(null, oddEvenAndCompareWith5Raw, sameNumberRaw, lessThan10Raw)).toEqual(expectedResult);
      expect(ArrayUtil.groupMapMultiKey(undefined, oddEvenAndCompareWith5Raw, sameNumberRaw, lessThan10Raw)).toEqual(expectedResult);
      expect(ArrayUtil.groupMapMultiKey(emptyArray, oddEvenAndCompareWith5Raw, sameNumberRaw, lessThan10Raw)).toEqual(expectedResult);
    });


    it('when given sourceArray is not empty but discriminatorKey or valueMapper are null or undefined then an error is thrown', () => {
      // @ts-ignore
      expect(() => ArrayUtil.groupMapMultiKey([ 1 ], null, sameNumberRaw, lessThan10Raw)).toThrowError(IllegalArgumentError);
      // @ts-ignore
      expect(() => ArrayUtil.groupMapMultiKey([ 1 ], undefined, sameNumberRaw, lessThan10Raw)).toThrowError(IllegalArgumentError);

      // @ts-ignore
      expect(() => ArrayUtil.groupMapMultiKey([ 1 ], oddEvenAndCompareWith5Raw, null, lessThan10Raw)).toThrowError(IllegalArgumentError);
      // @ts-ignore
      expect(() => ArrayUtil.groupMapMultiKey([ 1 ], oddEvenAndCompareWith5Raw, undefined, lessThan10Raw)).toThrowError(IllegalArgumentError);
    });
    ...
    it('when given sourceArray has elements and discriminatorKey and valueMapper are valid but filterPredicate is null or undefined then all elements will be transformed using discriminatorKey and valueMapper', () => {
      ...
      verifyMaps(
        // @ts-ignore
        ArrayUtil.groupMapMultiKey(sourceArray, oddEvenAndCompareWith5FFunction, sameNumberFFunction, null),
        expectedResult
      );
      verifyMaps(
        ArrayUtil.groupMapMultiKey(sourceArray, oddEvenAndCompareWith5FFunction, sameNumberFFunction, undefined),
        expectedResult
      );
    });
    ...
    it('when given sourceArray has elements and discriminatorKey, valueMapper and filterPredicate are valid then a new filtered and transformed Map is returned', () => {
      ...
      verifyMaps(
        ArrayUtil.groupMapMultiKey(sourceArray, oddEvenAndCompareWith5Raw, sameNumberRaw, lessThan10Raw),
        expectedResult
      );
    });
  ...
  describe('has', () => {
    ...
    it('when given sourceArray is undefined, null or is an empty array and item is provided then false is returned', () => {
      const emptyArray: Role[] = [];
      const role = { id: 1, name: 'role1' } as Role;

      expect(ArrayUtil.has(undefined, role)).toBe(false);
      expect(ArrayUtil.has(null, role)).toBe(false);
      expect(ArrayUtil.has(emptyArray, role)).toBe(false);
    });


    it('when given sourceArray is undefined, null or is an empty array and item and equalsFunction are provided then false is returned', () => {
      const emptyArray: Role[] = [];
      const role = { id: 1, name: 'role1' } as Role;

      expect(ArrayUtil.has(undefined, role, areAllRolePropertiesEqualsFPredicate)).toBe(false);
      expect(ArrayUtil.has(null, role, areAllRolePropertiesEqualsFPredicate)).toBe(false);
      expect(ArrayUtil.has(emptyArray, role, areAllRolePropertiesEqualsFPredicate)).toBe(false);
    });
    ...
    it('when given sourceArray is not empty, item is provided but there is no element that matches then false is returned', () => {
      const u1 = new User(1, 'user1');
      const u2 = new User(2, 'user2');
      const u3 = new User(1, 'user2');
      const u4 = new User(4, 'user1');
      ...
      expect(ArrayUtil.has(sourceArray, uToSearch)).toBe(false);
      expect(ArrayUtil.has(sourceArray, uToSearch, null)).toBe(false);
      expect(ArrayUtil.has(sourceArray, uToSearch, areUsersEqualsByIdRaw)).toBe(false);
      expect(ArrayUtil.has(sourceArray, uToSearch, areAllUserPropertiesEqualsFPredicate)).toBe(false);
      expect(ArrayUtil.has(sourceArray, uToSearch, areUsersEqualsPredicate)).toBe(false);
    });


    it('when given sourceArray is not empty, item is provided and there is an element that matches then true is returned', () => {
      const r1 = { id: 1, name: 'role1' } as Role;
      const r2 = { id: 2, name: 'role2' } as Role;
      const r3 = { id: 2, name: 'role3' } as Role;
      const r4 = { id: 4, name: 'role2' } as Role;
      ...
      expect(ArrayUtil.has(sourceArray, r2)).toBe(true);
      expect(ArrayUtil.has(sourceArray, r2, null)).toBe(true);
      expect(ArrayUtil.has(sourceArray, r3, areRolesEqualsByIdRaw)).toBe(true);
      expect(ArrayUtil.has(sourceArray, r2SameId, areRolesEqualsByIdRaw)).toBe(true);
      expect(ArrayUtil.has(sourceArray, r2Cloned, areAllRolePropertiesEqualsFPredicate)).toBe(true);
      expect(ArrayUtil.has(sourceArray, r3, areRolesEqualsPredicate)).toBe(true);
    });
  ...
  describe('isArray', () => {
    ...
    it('when given input is null or undefined then false will be returned', () => {
      ...
      expect(ArrayUtil.isArray()).toEqual(expectedResult);
      expect(ArrayUtil.isArray(undefined)).toEqual(expectedResult);
      expect(ArrayUtil.isArray(null)).toEqual(expectedResult);
    });


    it('when given input is not an array then false will be returned', () => {
      const user = new User(1, 'user1');

      const expectedResult = false;

      expect(ArrayUtil.isArray(12)).toEqual(expectedResult);
      expect(ArrayUtil.isArray("abc")).toEqual(expectedResult);
      expect(ArrayUtil.isArray({})).toEqual(expectedResult);
      expect(ArrayUtil.isArray(user)).toEqual(expectedResult);
    });
    ...
    it('when given input is an array then true will be returned', () => {
      ...
      expect(ArrayUtil.isArray([])).toEqual(expectedResult);
      expect(ArrayUtil.isArray(arrayNative)).toEqual(expectedResult);
      expect(ArrayUtil.isArray(arrayObject)).toEqual(expectedResult);
    });
  ...
  describe('max', () => {
    ...
    it('when given sourceArray has no elements and comparator is not provided then undefined is returned', () => {
      ...
      // @ts-ignore
      expect(ArrayUtil.max(null, null)).toBe(undefined);
      // @ts-ignore
      expect(ArrayUtil.max(undefined, undefined)).toBe(undefined);
      // @ts-ignore
      expect(ArrayUtil.max(emptyArray, null)).toBe(undefined);
      // @ts-ignore
      expect(ArrayUtil.max(emptyArray, undefined)).toBe(undefined);
    });
    ...
    it('when given sourceArray has no elements and comparator is provided then undefined is returned', () => {
      ...
      expect(ArrayUtil.max(null, comparator)).toBe(undefined);
      expect(ArrayUtil.max(undefined, comparator)).toBe(undefined);
      expect(ArrayUtil.max(emptyArray, comparator)).toBe(undefined);
    });
  ...
  describe('maxOptional', () => {
    ...
    it('when given sourceArray has no elements and comparator is not provided then empty Optional is returned', () => {
      ...
      // @ts-ignore
      expect(ArrayUtil.maxOptional(null, null).isPresent()).toBe(false);
      // @ts-ignore
      expect(ArrayUtil.maxOptional(undefined, undefined).isPresent()).toBe(false);
      // @ts-ignore
      expect(ArrayUtil.maxOptional(emptyArray, null).isPresent()).toBe(false);
      // @ts-ignore
      expect(ArrayUtil.maxOptional(emptyArray, undefined).isPresent()).toBe(false);
    });
    ...
    it('when given sourceArray has no elements and comparator is provided then empty Optional is returned', () => {
      ...
      expect(ArrayUtil.maxOptional(null, comparator).isPresent()).toBe(false);
      expect(ArrayUtil.maxOptional(undefined, comparator).isPresent()).toBe(false);
      expect(ArrayUtil.maxOptional(emptyArray, comparator).isPresent()).toBe(false);
    });
    ...
    it('when given sourceArray has elements and comparator is valid then an Optional with its largest value is returned', () => {
      ...
      expect(resultNumber.isPresent()).toBe(true);
      expect(resultNumber.get()).toEqual(21);

      expect(resultString.isPresent()).toBe(true);
  ...
  describe('min', () => {
    ...
    it('when given sourceArray has no elements and comparator is not provided then undefined is returned', () => {
      ...
      // @ts-ignore
      expect(ArrayUtil.min(null, null)).toBe(undefined);
      // @ts-ignore
      expect(ArrayUtil.min(undefined, undefined)).toBe(undefined);
      // @ts-ignore
      expect(ArrayUtil.min(emptyArray, null)).toBe(undefined);
      // @ts-ignore
      expect(ArrayUtil.min(emptyArray, undefined)).toBe(undefined);
    });
    ...
    it('when given sourceArray has no elements and comparator is provided then undefined is returned', () => {
      ...
      expect(ArrayUtil.min(null, comparator)).toBe(undefined);
      expect(ArrayUtil.min(undefined, comparator)).toBe(undefined);
      expect(ArrayUtil.min(emptyArray, comparator)).toBe(undefined);
    });
  ...
  describe('minOptional', () => {
    ...
    it('when given sourceArray has no elements and comparator is not provided then empty Optional is returned', () => {
      ...
      // @ts-ignore
      expect(ArrayUtil.minOptional(null, null).isPresent()).toBe(false);
      // @ts-ignore
      expect(ArrayUtil.minOptional(undefined, undefined).isPresent()).toBe(false);
      // @ts-ignore
      expect(ArrayUtil.minOptional(emptyArray, null).isPresent()).toBe(false);
      // @ts-ignore
      expect(ArrayUtil.minOptional(emptyArray, undefined).isPresent()).toBe(false);
    });
    ...
    it('when given sourceArray has no elements and comparator is provided then empty Optional is returned', () => {
      ...
      expect(ArrayUtil.minOptional(null, comparator).isPresent()).toBe(false);
      expect(ArrayUtil.minOptional(undefined, comparator).isPresent()).toBe(false);
      expect(ArrayUtil.minOptional(emptyArray, comparator).isPresent()).toBe(false);
    });
    ...
    it('when given sourceArray has elements and comparator is valid then an Optional with its largest value is returned', () => {
      ...
      expect(resultString.isPresent()).toBe(false);
    });
  ...
  describe('reduce', () => {
    ...
    it('when given sourceArray is null, undefined or empty then undefined is returned', () => {
      ...
      expect(ArrayUtil.reduce(null, intAccumulator)).toBe(undefined);
      expect(ArrayUtil.reduce(undefined, intAccumulator)).toBe(undefined);
      expect(ArrayUtil.reduce([], intAccumulator)).toBe(undefined);
    });
    ...
    it('when given sourceArray is not null and accumulator is valid then accumulator is applied to contained elements', () => {
      ...
      const intAccumulator =
        (n1: NullableOrUndefined<number>, n2: NullableOrUndefined<number>) => n1! * n2!;
      const stringAccumulator: FFunction2<NullableOrUndefined<string>, NullableOrUndefined<string>, string> =
        (s1: NullableOrUndefined<string>, s2: NullableOrUndefined<string>) => s1! + s2!;
  ...
  describe('toMap', () => {
    ...
    it('when given sourceArray has no elements and only discriminatorKey is provided then empty Map is returned', () => {
      const emptyArray: number[] = [];

      const expectedResult: Map<number, number> = new Map<number, number>;

      expect(ArrayUtil.toMap(null, sameNumberRaw)).toEqual(expectedResult);
      expect(ArrayUtil.toMap(undefined, sameNumberRaw)).toEqual(expectedResult);

      expect(ArrayUtil.toMap(emptyArray, sameNumberRaw)).toEqual(expectedResult);
      expect(ArrayUtil.toMap(emptyArray, sameNumberFFunction)).toEqual(expectedResult);

      expect(ArrayUtil.toMap(emptyArray, sameNumberRaw, plus1Raw)).toEqual(expectedResult);
      expect(ArrayUtil.toMap(emptyArray, sameNumberFFunction, plus1FFunction)).toEqual(expectedResult);
    });
    ...
    it('when given sourceArray is not empty but discriminatorKey or valueMapper are null or undefined then an error is thrown', () => {
      ...
      // @ts-ignore
      expect(() => ArrayUtil.toMap([ 1 ], null, plus1Raw)).toThrowError(IllegalArgumentError);
      // @ts-ignore
      expect(() => ArrayUtil.toMap([ 1 ], undefined, plus1FFunction)).toThrowError(IllegalArgumentError);
    });


    it('when given sourceArray has elements and only discriminatorKey is provided then all elements will be split using discriminatorKey', () => {
      const sourceArray: number[] = [ 1, 2, 3, 6, 3 ];
      ...
      verifyMaps(
        ArrayUtil.toMap(sourceArray, sameNumberRaw),
        expectedResult
      );
      verifyMaps(
        ArrayUtil.toMap(sourceArray, sameNumberFFunction),
        expectedResult
      );
    });


    it('when given sourceArray has elements and discriminatorKey and valueMapper are provided then all elements will be transformed using discriminatorKey and valueMapper', () => {
      const sourceArray: number[] = [ 1, 2, 3, 6, 3 ];
      ...
      verifyMaps(
        ArrayUtil.toMap(sourceArray, sameNumberRaw, plus1Raw),
        expectedResult
      );
      verifyMaps(
        ArrayUtil.toMap(sourceArray, sameNumberRaw, plus1FFunction),
        expectedResult
      );
      verifyMaps(
        ArrayUtil.toMap(sourceArray, sameNumberFFunction, plus1FFunction),
        expectedResult
      );
      verifyMaps(
        ArrayUtil.toMap(sourceArray, sameNumberFFunction, plus1Function),
        expectedResult
      );
    });
...
function verifyMatrix(actualMatrix: unknown[][],
