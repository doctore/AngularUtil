...
describe('NumberUtil', () => {
  ...
  describe('toFloatWithFixedPointNotation', () => {
    ...
    it('when given inputToFix is undefined or null then undefined is returned', () => {
      expect(NumberUtil.toFloatWithFixedPointNotation(undefined, undefined)).toBe(undefined);
      expect(NumberUtil.toFloatWithFixedPointNotation(null, null )).toBe(undefined);

      expect(NumberUtil.toFloatWithFixedPointNotation(undefined, 1)).toBe(undefined);
      expect(NumberUtil.toFloatWithFixedPointNotation(null, 2 )).toBe(undefined);
    });


    it('when given inputToFix is not a valid float then undefined string is returned', () => {
      expect(NumberUtil.toFloatWithFixedPointNotation('1..1')).toBe(undefined);
      expect(NumberUtil.toFloatWithFixedPointNotation('abc')).toBe(undefined);
      expect(NumberUtil.toFloatWithFixedPointNotation('2Ee')).toBe(undefined);
      expect(NumberUtil.toFloatWithFixedPointNotation('1.13aebc')).toBe(undefined);

      expect(NumberUtil.toFloatWithFixedPointNotation('1..1', 1)).toBe(undefined);
      expect(NumberUtil.toFloatWithFixedPointNotation('abc', 2)).toBe(undefined);
      expect(NumberUtil.toFloatWithFixedPointNotation('2Ee', 3)).toBe(undefined);
      expect(NumberUtil.toFloatWithFixedPointNotation('1.13aebc', 4)).toBe(undefined);
    });
