...
describe('Predicate7', () => {
  ...
  describe('or', () => {
    ...
    it('when both Predicates return true then true is returned', () => {
      ...
      expect(orPredicates1.apply(12, 'abcdef', 'abcdefg', 10, 6, 2, 4)).toBeTrue();
      expect(orPredicates1.apply(16, '123456', '123567', 8, 14, 4, 18)).toBeTrue();

      expect(orPredicates2.apply(12, 'abcdef', 'abcdefg', 10, 6, 2, 4)).toBeTrue();
      expect(orPredicates2.apply(16, '123456', '123567', 8, 14, 4, 18)).toBeTrue();
    });
  ...
  describe('xor', () => {
    ...
    it('when given Predicate is null or undefined then only this will be evaluated', () => {
      ...
      expect(xorPredicates.apply(12, 'abcd', 'ab', 10, 16, 15, 11)).toBeFalse();
      expect(xorPredicates.apply(8, 'abc', 'Hello', 9, 17, 65, 21)).toBeFalse();
      expect(xorPredicates.apply(12, 'abcd', 'Hello', 14, 6, 56, 34)).toBeTrue();
      expect(xorPredicates.apply(4, 'abc', 'Hola', 6, 18, 14, 2)).toBeTrue();
    });
    ...
    it('when one of the Predicates to evaluate returns true then true is returned', () => {
      ...
      expect(xorPredicates1.apply(22, 'abcd', 'Hello', 12, 6, 10, 34)).toBeTrue();
      expect(xorPredicates1.apply(2, 'Hola', 'abc', 30, 8, 12, 44)).toBeTrue();

      expect(xorPredicates2.apply(19, 'abcdef', 'HelloWorld', 13, 12, 15, 8)).toBeTrue();
      expect(xorPredicates2.apply(11, 'abcdef', 'HolaMundo', 15, 10, 5, 16)).toBeTrue();
    });
    ...
    it('when both Predicates return false then false is returned', () => {
      ...
      expect(xorPredicates1.apply(21, 'ab', '', 10, 6, 35, 41)).toBeFalse();
      expect(xorPredicates1.apply(22, 'abc', 'a', 30, 15, 13, 18)).toBeFalse();
      expect(xorPredicates1.apply(10, 'ab', 'Hello', 19, 14, 22, 2)).toBeFalse();

      expect(xorPredicates2.apply(21, 'ab', '', 10, 6, 35, 41)).toBeFalse();
      expect(xorPredicates2.apply(22, 'abc', 'a', 30, 15, 13, 18)).toBeFalse();
      expect(xorPredicates2.apply(10, 'ab', 'Hello', 19, 14, 22, 2)).toBeFalse();
    });
    ...
    it('when both Predicates return true then false is returned', () => {
      ...
      expect(xorPredicates1.apply(12, 'abcdef', 'abcdefg', 10, 6, 2, 4)).toBeFalse();
      expect(xorPredicates1.apply(16, '123456', '123567', 8, 14, 4, 18)).toBeFalse();

      expect(xorPredicates2.apply(12, 'abcdef', 'abcdefg', 10, 6, 2, 4)).toBeFalse();
      expect(xorPredicates2.apply(16, '123456', '123567', 8, 14, 4, 18)).toBeFalse();
    });
